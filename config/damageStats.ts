export default {
  ...
  metrics: [
    ...
    { stat: '31,643', emphasis: 'Death toll', rest: 'from the latest official figures.' , source: 'https://www.washingtonpost.com/world/2023/02/13/turkey-syria-earthquake-updates-deaths/'},
