...
const NETWORKS = ["Bitcoin", "Ethereum", "Avalanche", "Binance", "Polygon", "Solana", "Cosmos", "Polkadot", "Tron", "Mina", "Cardano", "VeChain", "Waves", "Tezos", "Celo", "Gnosis", "Arbitrum", "Optimism", ];
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        sourceUrls: ['https://www.kizilay.org.tr/donation-methods/crypto-donation-accountwallet-informations', 'https://donation.btcturk.com/'],
        warning: "Only send DOT as this is an exchange wallet",
      },
      {
        type: "cryptocurrency",
